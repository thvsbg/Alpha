...
let contactbtn1=document.getElementById('price-btn-1');
let contactbtn2=document.getElementById('price-btn-2');
let contactbtn3=document.getElementById('price-btn-3');
let contactbtn4=document.getElementById('enquire-btn');
...
var submitbtn=document.getElementById('submitbtn');
  ...
  submitbtn.addEventListener('click',function(e) {
    ...
    Email.send({
        ...
        To : 'thetiwariankush@gmail.com',
        From : "saviandemo@gmail.com",
        Subject : "Enquiry Request - Bhutani Alphathum",
        Body : body
    }).then(
        Swal.fire({
              title: 'Success',
